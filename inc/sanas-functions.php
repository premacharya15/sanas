              ...
              <div class="login-form">
                <form method="post" id="usersignup">
                 ...
                 <!-- <div class="form-group">
                  ...
                  <input type="hidden" id="popup-card-id1">
                  <input type="hidden" id="popup-front-img1">
                  <input type="hidden" id="popup-back-img1">
                  <input type="hidden" id="popup-card-title1">
                  <input type="hidden" id="popup-bgcolor-code1">
                  <div class="form-group">
    ...
    data-card-id="">
      <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content card-preview-popup-model">
              <div class="modal-body">
                <div class="modal-header card-preview-popup-close">
          ...
          <div class="modal-content custom-modal-height">
              ...
              <div class="modal-body">
                  <div class="category-grid">
                      <div class="update-category-name">Selected Category: <span id="selected-category-name"></span></div>
