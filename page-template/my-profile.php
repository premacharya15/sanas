              ...
              <div class="tab" id="tab-16">
                <div class="form-block del-account">
                  <div class="form-box">
                    ...
                    <button type="submit" class="dashbord-btn delete-account-btn" style="color: #744f307a !important; hover:background-color: #744f307a !important;" disabled>Delete My Account</button>
                  </div>
                </div>
              </div>
            </div>
