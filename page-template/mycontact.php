                                            ...
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    <div>
                                                        ...
                                                        <a href="javascript:void(0)" onclick="delete_guest_details(<?php echo esc_attr($guest->guest_id);?>) confirm('Are you sure you want to delete this guest?')" class="delete theme-btn">
