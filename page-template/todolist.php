                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($items as $item): ?>
                                        ...
                                        <option value="Completed" <?php echo selected($item['status'], 'Completed', false); ?> data-bs-toggle="tooltip" data-bs-original-title="Completed">✅</option>
                                                ...
                                                <select class="status-dropdown smallfont desktop-dropdown text-single-line" data-id="<?php echo $item['id']; ?>" data-bs-toggle="tooltip" data-bs-original-title="Yet To Start">
