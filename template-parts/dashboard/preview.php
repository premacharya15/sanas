                    ...
                    <div class="row">
                        ...
                        <div class="wl-card-detaile">
                            ...
                            <div class="wl-inner-card-detaile wl-previewbox">
                                ...
                                <div class="rsvp-event" style="background: transparent !important;border:none !important; padding: 20px 20px 20px 20px;margin:0;">
                                    <div class="rsvp-from-group">
                            ...
                            <div class="row col-xxl-8 col-xl-9 col-lg-9 col-md-12 m-auto mt-0 position-relative">
                                ...
                                <div class="row">
                                    <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 m-auto" style="padding: 0 20px;">
