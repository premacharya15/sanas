                        ...
                        <div class="wl-card-detaile">
                            ...
                            <div class="row col-xxl-8 col-xl-9 col-lg-9 col-md-12 m-auto mt-0 position-relative">
                                <div class="rsvp-event" style="background: transparent !important;border:none !important; padding: 0px 20px;margin-top: 0 !important;">
                                    ...
                                    <div class="rsvp-from-group">
                                        <div class="event-date px-1" style="<?php echo $event_date_css; ?>">
                                            <?php
                                    ...
                                    <div class="rsvp-from-group m-0 map-container-rsvp">
                                        <!-- <h4>Address</h4> -->
                                            <div class="map-input-rsvp map-input-rsvp-black m-0 px-1 edit-text rsvp-msg event_venue_name" id="search" type="text"><?php echo esc_html($event_venue_name); ?></div>
                                            <div class="map-input-rsvp map-input-rsvp-black m-0 px-1 edit-text rsvp-msg event_venue_address" id="search_address" rows="2" cols="50"><?php echo esc_html($event_venue_address); ?></div>
