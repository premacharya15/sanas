                                    ...
                                    <div class="form-group-outer">
                                        ...
                                        <div class="form-group">
                                            <div class="select-wrapper">
                                                        ...
                                                        onclick="changeAlignText('left', event)">
                                                        <i class="fa-solid fa-align-left"></i>
                                                    </a>
                                                    <a href="#" id="text-align-center" data-title="center"
                                                        onclick="changeAlignText('center', event)">
                                                        <i class="fa-solid fa-align-center"></i>
                                                    </a>
                                                    <a href="#" id="text-align-right" data-title="right"
                                                        onclick="changeAlignText('right', event)">
            ...
            <div class="inner-colum" id="canvasElement">
                <div class="content content-3">
                    ...
                    <div class="wl-card-detaile">
                        <div class="row">
                            <div class="col-xxl-9 col-xl-10 col-lg-10 col-md-12 m-auto position-relative">
                    ...
                    <?php } ?>
                            ...
                            <div class="rsvp-from-group">
                                ...
                                <div class="rsvp-from-group m-0 map-container-rsvp">
                                    <!-- <h4>Address</h4> -->
                                        <input class="map-input-rsvp m-0 edit-text rsvp-msg event_venue_name" id="search" type="text" name="venue_name" placeholder="Enter Venue Name" value="<?php echo esc_html($event_venue_name); ?>" required="">
                                        <textarea class="map-input-rsvp m-0 edit-text rsvp-msg event_venue_address" id="search_address" rows="2" cols="50" name="venue_address" placeholder="Venue Address" required=""><?php echo esc_html($event_venue_address); ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-xxl-6 col-xl-6 col-lg-7 col-md-8 col-sm-12 m-auto">
                                    ...
                                    <?php endforeach; }
                                        ...
                                        ?>
                                          <tr>
                                              ...
                                              <td class="edit-text text-start" contenteditable="true" data-placeholder="7:00 PM"></td>
                                              <td>
                                                <button class="deleteRowBtn"><i class="fa-regular fa-trash-can"></i></button>
                                             </td>
                                             </tr>
